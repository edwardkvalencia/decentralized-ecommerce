...
class Buy extends Component {
    ...
    async buyProduct() {
        await contract.methods.buyProduct(
            ...
            this.state.lineOneDirection,
            this.state.lineTwoDirection,
            this.bytes32(this.state.city),
            this.bytes32(this.state.stateRegion),
            this.state.postalCode,
            this.bytes32(this.state.country),
            this.state.phone
        ).send({
        ...
        return (
            <div>
                ...
                <div className="shipping-buy-page">
                    ...
                    }} placeholder="Line 1 Delivery Address" type="text"
                    />

                    <input onChange={e => {
                        this.setState({lineTwoDirection: e.target.value})
                    }} placeholder="Line 2 Delivery Address" type="text"
                    />
                    ...
                    <button onClick={() => {
                        this.buyProduct()
                    }}>Buy and send to this address</button>
                </div>
            </div>
        )
    }
